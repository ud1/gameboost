...
inline Vector4f operator * ( const Vector4f& V, const Matrix4x4f& M )
{
	...
	__m128 VT0 = V.vec;
	__m128 VT1 = VT0;
	VT1 = _mm_shuffle_ps(VT1, VT0, _MM_SHUFFLE(0, 0, 0, 0));
	VT1 = _mm_mul_ps(VT1, M.row0);
	__m128 VT2 = VT0;
	VT2 = _mm_shuffle_ps(VT2, VT0, _MM_SHUFFLE(1, 1, 1, 1));
	VT2 = _mm_mul_ps(VT2, M.row1);
	VT1 = _mm_add_ps(VT1,VT2);
	VT2 = VT0;
	VT2 = _mm_shuffle_ps(VT2, VT0, _MM_SHUFFLE(2, 2, 2, 2));
	VT2 = _mm_mul_ps(VT2, M.row2);
	VT1 = _mm_add_ps(VT1,VT2);
	VT2 = VT0;
	VT2 = _mm_shuffle_ps(VT2, VT0, _MM_SHUFFLE(3, 3, 3, 3));
	VT2 = _mm_mul_ps(VT2, M.row3);
	VT1 = _mm_add_ps(VT1,VT2);
