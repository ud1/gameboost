...
//#include "pch.h"
  ...
  bool D3DVERTEXBLENDFLAGS_fromstr(D3DVERTEXBLENDFLAGS &val, const std::string &s)
  {
    ...
    if (s == "D3DVBF_1WEIGHTS")
    {
      val = D3DVBF_1WEIGHTS;
      return true;
    };
    if (s == "D3DVBF_2WEIGHTS")
    {
      val = D3DVBF_2WEIGHTS;
      return true;
    };
    if (s == "D3DVBF_3WEIGHTS")
    {
      val = D3DVBF_3WEIGHTS;
      return true;
    };
    if (s == "D3DVBF_TWEENING")
    {
      val = D3DVBF_TWEENING;
      return true;
    };
    if (s == "D3DVBF_0WEIGHTS")
    {
      val = D3DVBF_0WEIGHTS;
      return true;
    };
  ...
  std::string D3DRENDERSTATEVALUE_tostr(const D3DRENDERSTATETYPE state, const DWORD val)
  {
    ...
    switch (state)
    {
      ...
      case D3DRS_FILLMODE:
        {
          ss = D3DFILLMODE_tostr((D3DFILLMODE)val);
        }
        break;
      ...
      case D3DRS_SHADEMODE:
        {
          ss = D3DSHADEMODE_tostr((D3DSHADEMODE)val);
        }
        break;
      ...
      case D3DRS_ZFUNC:
        {
          ss = D3DCMPFUNC_tostr((D3DCMPFUNC)val);
        }
        break;
      ...
      case D3DRS_FOGTABLEMODE:
        {
          ss = D3DFOGMODE_tostr((D3DFOGMODE)val);
        }
        break;
      ...
      case D3DRS_VERTEXBLEND:
        {
          ss = D3DVERTEXBLENDFLAGS_tostr((D3DVERTEXBLENDFLAGS)val);
        }
        break;
  ...
  bool D3DRENDERSTATEVALUE_fromstr(DWORD &val, const D3DRENDERSTATETYPE state, const std::string &s)
  {
    ...
    switch (state)
    {
      ...
      case D3DRS_FILLMODE:
        {
          return D3DFILLMODE_fromstr((D3DFILLMODE &)val, s);
        }
        break;

      case D3DRS_SHADEMODE:
        {
          return D3DSHADEMODE_fromstr((D3DSHADEMODE &)val, s);
        }
        break;
      ...
      case D3DRS_SRCBLEND:
        {
          return D3DBLEND_fromstr((D3DBLEND &)val, s);
        }
        break;
      case D3DRS_DESTBLEND:
        {
      ...
      case D3DRS_CULLMODE:
        {
          return D3DCULL_fromstr((D3DCULL &)val, s);
        }
        break;

      case D3DRS_ZFUNC:
        {
          return D3DCMPFUNC_fromstr((D3DCMPFUNC &)val, s);
        }
        break;
      ...
      case D3DRS_FOGTABLEMODE:
        {
          return D3DFOGMODE_fromstr((D3DFOGMODE &)val, s);
        }
        break;
      case D3DRS_FOGSTART:
        {
      ...
      case D3DRS_STENCILFAIL:
        {
          return D3DSTENCILOP_fromstr((D3DSTENCILOP &)val, s);
        }
        break;
      case D3DRS_STENCILZFAIL:
        {
      ...
      case D3DRS_VERTEXBLEND:
        {
          return D3DVERTEXBLENDFLAGS_fromstr((D3DVERTEXBLENDFLAGS &)val, s.c_str());
        }
        break;
      case D3DRS_CLIPPLANEENABLE:
        {
      ...
      case D3DRS_PATCHEDGESTYLE:
        {
          return D3DPATCHEDGESTYLE_fromstr((D3DPATCHEDGESTYLE &)val, s);
        }
        break;

      case D3DRS_DEBUGMONITORTOKEN:
        {
          return D3DDEBUGMONITORTOKENS_fromstr((D3DDEBUGMONITORTOKENS &)val, s);
        }
        break;
      ...
      case D3DRS_POSITIONDEGREE:
        {
          return D3DDEGREETYPE_fromstr((D3DDEGREETYPE &)val, s);
        }
        break;
