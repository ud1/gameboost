...
//--------------------------------------------------------------------------------------
ScrollBar::ScrollBar( Dialog *pDialog )
{
	m_Type = MYUT_CONTROL_TYPE::SCROLLBAR;
	m_pDialog = pDialog;
...
//--------------------------------------------------------------------------------------
void ScrollBar::Render( IDirect3DDevice9* pd3dDevice, float fElapsedTime )
{
	...
	if( m_Arrow != CLEAR )
	{
		double dCurrTime = getGlobalTime();
