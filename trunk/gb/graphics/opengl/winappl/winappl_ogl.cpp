...
#pragma message("KS777: ??????  do shutdown ...  " __FILE__ )
	...
	case WM_CREATE: 
     ...
     #pragma message("KS777: ÒÓÒ ÁÛ ÏÎÑÒÀÂÈÒÜ âûçîâ î ñîçäàíèè êîíòåêñòà ")
...
//		this->m_oglInitdata
	...
	{
		MessageBoxA(NULL, "Ïîëíîýêðàííûé ðåæèì ïîêà îòêëþ÷¸í", "ApplOpenGL", 
...
#pragma message("ÍÅ ÎÒÎÁÐÀÆÀÅÒÑß ÍÀÄÏÈÑÜ ÎÊÍÀ ÏÐÈ MULTIBYTE" __FILE__) 
...
#pragma message("KS777: âîçìîæíî ïåðåíåñòè funcOnDestroyDrawContext " __FILE__ )
